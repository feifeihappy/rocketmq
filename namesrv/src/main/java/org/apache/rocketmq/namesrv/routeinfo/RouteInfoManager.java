...
public class RouteInfoManager {
    ...
    //路由信息
    private final HashMap<String/* topic */, List<QueueData>> topicQueueTable;//Topic 消息队列路由信息
    private final HashMap<String/* brokerName */, BrokerData> brokerAddrTable;//Broker 节点信息
    private final HashMap<String/* clusterName */, Set<String/* brokerName */>> clusterAddrTable;//broker 集群信息
    private final HashMap<String/* brokerAddr */, BrokerLiveInfo> brokerLiveTable;//broker 状态信息
